...
class  Camera{
    public String camera(int number ){
        return number == 0 ? "Camere is Turn on": "Camera is TunOFF";         
    }   
}
interface PhoneManager {
    void call(String number);
    default String camera(int number ){
        return number == 1 ? "Camere is Turn onn": "Camera is TurnOFF";         
    }       
}
interface  Music{
...
public class MultipleInheritance {
    public static void main(String[] args) {
        ...
        System.out.println(objPhone.camera(1));
